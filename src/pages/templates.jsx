...
const templates_array = [
  ...
  },
  {
    id: "artistic",
    name: "Artistic",
    image: "/avatars/boy1.jpeg",
    description:
      "An artistic and expressive layout to showcase your creative work.",
    category: "Art",
...
function Templates() {
  ...
  useEffect(() => {
    const filtered = templates_array.filter(
      (template) =>
        template.category
          .toLowerCase()
